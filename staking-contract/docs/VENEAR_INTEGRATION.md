...
sequenceDiagram
    ...
    User->>StakeDao: lock_for_product + NEAR
...
- `lock_for_product(..., register_with_venear: Option<bool>)`
- `lock_for_subscription(..., register_with_venear: Option<bool>)`
