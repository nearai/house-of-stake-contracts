...
This snapshot records the shared testnet contract state used as the operational
baseline in [PR 85](https://github.com/nearai/house-of-stake-contracts/pull/85).
Use it when upgrading the shared E2E contract from that baseline to newer
`main` contract builds.
